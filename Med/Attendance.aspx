            ...
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="View1" runat="server">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        GridLines="Vertical" PageIndex="31" PageSize="31" Width="454px" 
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <asp:SqlDataSource ID="SqlDS_FWHistory" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM HRDS_OB_Tran WHERE (IDNo = @IDNo) AND (StartDate &gt;= @startdate) AND (EndDate &lt;= @enddate) AND (Approval = 'Y')">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblidno" Name="IDNO" PropertyName="Text" />
